...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5fe99f468880180015745443
...
To start editing your site, you can use the Sanity interface at https://thoughtful-olive-99f46.sanity.studio/.
...
Generated at `2020-12-28T09:03:26.529Z` by Stackbit version `0.3.41`.